...
/*
 * Check Old React JS Version
 * https://codesandbox.io/s/react-simple-rating-rx84o
 *
 * Repo: https://github.com/awran5/react-simple-star-rating
 */
            ...
            <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
              <div className="col-10 col-sm-8 col-lg-6 mx-auto">
                ...
                <p className="lead mb-4">
                  A simple yet powerful react component for adding a nice rating
                  icons to your project.
                </p>
...
`}
              ...
              <div className="box">
                ...
                <p>
                  Using <code>transition</code> prop to add a smooth{" "}
                  <code>width</code> and <code>fill</code> transition on mouse
                  hover.
                </p>
                <div className="demo">
                  <Rating
...
/>`}
              ...
              <div className="box">
                <h3 id="tooltip-array">
                  <a href="#tooltip-array">#4 </a>Custom tooltip text based on
                  value
                </h3>
                <p>
                  By define <code>tooltipArray</code> prop. You can display a
                  label with live value on hover to help the user pick the
                  correct choice. <br />
                </p>
...
/>`}
              ...
              <div className="box">
                ...
                <p>
                  Readonly mode. You can set <code>readonly</code> to{" "}
                  <b>ture</b> or use it as a condition to completely disable the
                  component when the condition is met.
                </p>
                <div className="demo">
                  <Rating
...
/>`}
              ...
              <div className="box">
                ...
                <p>
                  By adding an SVG with <code>fullIcon</code> |{" "}
                  <code>emptyIcon</code> props.
                </p>
                <p>
                  ...
                  . If you like to use your own custom SVG, you need to to set
                  the <code>fill</code> attribute to <code>currentColor</code>
                </p>
                <div className="demo">
                  <Rating
...
/>`}
              ...
              <div className="box">
                ...
                <p>
                  You can add a group of icons with <code>customIcons</code>{" "}
                  props.
                </p>
                <div className="demo">
                  <Rating
...
/>`}
              ...
              <div className="box">
                ...
                <p>
                  If you like, you can disable hover effect with{" "}
                  <code>allowHover</code> prop.
                </p>
                <div className="demo">
                  <Rating
                    onClick={handleRating9}
                    ratingValue={rating9}
                    allowHover={false}
                    size={50}
                  />
...
/>`}
              ...
              <div className="box">
                ...
                <p>
                  Enable a fractional (half icon) with{" "}
                  <code>allowHalfIcon</code> prop.
                </p>
                <div className="demo">
                  <Rating
                    onClick={handleRating10}
                    ratingValue={rating10}
                    transition
                    size={50}
                    allowHalfIcon
                  />
...
/>`}
              ...
              <div className="box">
                ...
                <p>
                  In order to reset the rating value, you need to set{" "}
                  <code>initialValue</code> prop to your desired value, then you
                  can reset the value with your <code>state handler</code>
                </p>
                <div className="demo">
                  <Rating
      ...
      <footer className="footer mt-auto py-3 bg-light text-center">
        <div className="container">
          <span className="text-muted">
            by <a href="https://github.com/awran5">awran5 </a>{" "}
            <span className="px-2">|</span>
            <a href="https://github.com/awran5/react-simple-star-rating">
              Github
            </a>
          </span>
        </div>
